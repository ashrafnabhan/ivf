...
\urlstyle{same}
\hypersetup{
  pdftitle={Gynecologists' Knowledge of Non-Recommended Infertility Practices: protocol of a cross-sectional e-survey},
  colorlinks=true,
  linkcolor={blue},
  filecolor={Maroon},
  citecolor={Blue},
...
Practices: protocol of a cross-sectional e-survey}
\author{}
\date{}
\begin{document}
\maketitle
...
Management of subfertile couples, including IVF/ICSI, involves a
